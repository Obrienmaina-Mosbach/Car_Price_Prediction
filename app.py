...
# IMPORTANT: Replace '1.3.0' with the exact scikit-learn version you used when training the model.
# You can find this by running `print(sklearn.__version__)` in your training environment.
...
# --- Streamlit App UI ---
st.set_page_config(page_title="Australian Car Price Predictor", layout="centered")
...
with st.form("car_prediction_form"):
    ...
    with col1:
        ...
        # Ensure cylinders dropdown matches known values and provides a default
